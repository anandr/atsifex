function [ret,propVal] = atsifex_getpropertyvalue(source, propName)

% [ret,propVal] = atsifex_getpropertyvalue(source, propName)
%
...
[ret,propVal] = atsifiomex('ATSIF_GetPropertyValue', source, propName);     atsifex_CheckReturnCode(ret);
