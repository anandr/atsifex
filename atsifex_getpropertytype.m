function [ret,type] = atsifex_getpropertytype(source, propName)

% [ret,type] = atsifex_getpropertytype(source, propName)
%
...
[ret,propType] = atsifiomex('ATSIF_GetPropertyType', source, propName);     atsifex_CheckReturnCode(ret);
